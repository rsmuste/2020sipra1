...
import static es.sistemasinteligentes.practica1si.GameMain.mundo;
...
public class MenuPrincipal implements Screen{
    ...
    void addAllListeners(){
        playBtn.addListener(new ChangeListener(){
            ...
            // Muestra ventana para elegir el mundo    
            ...
            f.dispose();
            String fichero_mundo;             
            
            if (res == JFileChooser.APPROVE_OPTION) { 
                fichero_mundo = chooser.getName(chooser.getSelectedFile());
